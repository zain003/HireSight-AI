...
| `FEAT-004-BE-cv-facial-movement-engine.md` | Backend | P0 | Observable Computer Vision Engine | `000-shared-contracts` | Normalized gaze & 3D head pose estimation | ☐ Ready |
| `FEAT-004-VERIFY-cv-engine.md` | Verify | P0 | CV Engine Verification | `FEAT-004-BE` | Landmark normalization & resolution tests | ☐ Ready |
