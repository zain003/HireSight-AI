...
**Execution Timestamp**: 2026-09-06T23:58:59.122297Z
...
- [x] **key_concepts_expected has >= 2 items for every question**: `PASSED` Concept counts: [2, 2, 2, 2, 2, 2]
...
- [x] **InterviewSession schema retains all rubric subfields without data loss**: `PASSED` Ref Answer: 'The candidate gives a concise profession...', Concepts: ['Python', 'FastAPI']
...
- [x] **Fallback execution completes in < 50ms on API failure**: `PASSED` Measured latency: 0.074ms (Limit: 50.0ms)
